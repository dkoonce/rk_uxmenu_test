...
import com.rkbots.tools.app.uxmenu.slidinglayout.SLConfig.Tile;
...
public class SLKeyframe {
    ...
    public SLKeyframe setStartSide(SLSide side, List<Component> cmps) {
        cmpsWithStartSide.get(side).addAll(cmps);
        return this;
    }
    ...
    public SLKeyframe setEndSide(SLSide side, List<Component> cmps) {
        cmpsWithEndSide.get(side).addAll(cmps);
        return this;
    }
