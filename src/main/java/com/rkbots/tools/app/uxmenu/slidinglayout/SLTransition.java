 ...
 * <p/>
 *
 * If a component is present on a keyframe but absent from the current configuration, it will be
 ...
 * <p/>
 *
 * Similarly, if a component is present in the current configuration but absent from the next
