 ...
 * {@link SLConfig configurations}. A configuration is a layout of the panel children. The panel can
 * then create smooth transitions between two configurations.
 * <p>
 * <
 * pre>
...
public class SLPanel extends JLayeredPane {
    ...
    public void setTweenManager(TweenManager tweenManager) {
        ...
        // System.out.println("TweenManager Set");
    }
